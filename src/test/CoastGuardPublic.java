...
public class CoastGuardPublic {
	...
	public void testb5() throws Exception {
		String solution = CoastGuard.solve(grid5, "DF", true);
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	@Test(timeout = 10000)
	...
	public void testc6() throws Exception {
		String solution = CoastGuard.solve(grid6, "UC", true);
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	@Test(timeout = 60000)
	...
	public void teste9() throws Exception {
		String solution = CoastGuard.solve(grid9, "GR1", true);
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	@Test(timeout = 60000)
	...
	public void testf1() throws Exception {
		String solution = CoastGuard.solve("3,4;97;1,2;0,1;3,2,65;", "DF", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan("3,4;97;1,2;0,1;3,2,65;", solution));
	}
	...
	public void testf3() throws Exception {
		String solution = CoastGuard.solve(grid3, "GR2", false);
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void testf6() throws Exception {
		String solution = CoastGuard.solve(grid6, "GR2", true);
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	@Test(timeout = 60000)
	...
	public void testg0() throws Exception {
		String solution = CoastGuard.solve(grid0, "AS1", true);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	static class Checker{
		...
		ArrayList<String> is = new ArrayList<String>(); // stations
		byte s;
		int r;
		int d;
		byte x00;// i
	...
	public static boolean applyPlan(String grid, String solution){
		...
		int blue = Integer.parseInt(solutionArray[1]); //num of deaths
		int doors = Integer.parseInt(solutionArray[2]); // boxes retrieved
